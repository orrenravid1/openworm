...
#define nrn_init _nrn_init__neuron_to_neuron_elec_syn
#define _nrn_initial _nrn_initial__neuron_to_neuron_elec_syn
#define nrn_cur _nrn_cur__neuron_to_neuron_elec_syn
#define _nrn_current _nrn_current__neuron_to_neuron_elec_syn
#define nrn_jacob _nrn_jacob__neuron_to_neuron_elec_syn
#define nrn_state _nrn_state__neuron_to_neuron_elec_syn
#define _net_receive _net_receive__neuron_to_neuron_elec_syn 
#define rates rates__neuron_to_neuron_elec_syn 
#define states states__neuron_to_neuron_elec_syn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _neuron_to_neuron_elec_syn_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 neuron_to_neuron_elec_syn /mnt/c/Users/orren/python_projects/openworm/networks/c302_A_Full/neuron_to_neuron_elec_syn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=neuron_to_neuron_elec_syn type=expTwoSynapse)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/c/Users/orren/python_projects/openworm/networks/c302_A_Full/neuron_to_neuron_elec_syn.mod";
static const char* nmodl_file_text = 
